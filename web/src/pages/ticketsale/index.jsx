...
const TicketSale = () => {
    ...
    const ticketSaleService = async (values) => {
      try {
        setIsLoading(true);
        const url = "http://localhost:5000/user/ticketsale";
        ...
        if (status === "success") {
          ...
          console.log("Navigating to /user/ticketsale/thankyou3"); // Add this line for debugging
          navigate("/user/ticketsale/thankyou3");
        } else {
    ...
    return(
      ...
      <br></br>
        ...
        <div className="container">
            <div className="title">SALE YOUR TICKET NOW</div>
                ...
                <form onSubmit={handleFormSubmit}>
                    <div className="user-details">
                        ...
                        <div className="input-box">
                            ...
                            <input type="number" placeholder="No of tickets to sell" name="ticket"
                    ...
                    {/* Link to Login Page */}
                    <Link to="/ticketbook" className="login-link">
                    Want to BuyTicket? Book Tickets          
                    </Link>
                </form>
            </div>
        </div>
